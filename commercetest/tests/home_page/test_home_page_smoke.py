...
class TestHomePageSmoke:
    ...
    def test_verify_shop_header_is_displayed(self,setup):
        ...
        self.header.verify_shop_header_is_displayed()
    ...
    def test_verify_header_is_displayed(self, setup):
        self.header = Header(self.driver)
        self.header.verify_header_is_displayed()

    @pytest.mark.tcid68
    def test_verify_header_menu_is_displayed(self, setup):
        self.header = Header(self.driver)
        self.header.verify_header_menu_is_displayed()

    @pytest.mark.tcid73
    def test_verify_top_nav_correct_items_are_displayed(self, setup):
        self.header = Header(self.driver)
        nav_items_list = self.header.verify_top_nav_correct_items_are_displayed()
    ...
    def test_verify_top_nav_items_leads_correct_url(self, setup):
        self.header = Header(self.driver)
        nav_items_link_url_list = self.header.verify_top_nav_items_lead_correct_url()
